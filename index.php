...
include('src/configs/constants.php');
...
if (isset($_SESSION['job'])) {
  renderToastMessage($_SESSION['job'], 'success');
  unset($_SESSION['job']);
}
...
$result = mysqli_query($connection,  "SELECT 
          ...
          JOIN category ON job.category_id = category.id") or die(mysqlI_error($connection));
...
<main class="w-full mx-auto">
  ...
  <div
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Here at Flowbite
        <?php echo $job_count; ?> full-time and remote jobs hiring now</p>
    </div>
  </div>
  ...
  <div class="mx-auto max-w-3xl p-4 my-8 border border-gray-200 rounded-lg shadow sm:p-8">
    ...
    <a href="/php-/src/views/applications/new.php?id=<?php echo $id; ?>"
